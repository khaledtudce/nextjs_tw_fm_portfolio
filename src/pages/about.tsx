...
const about = () => {
  return (
    <>
      <Head>
        <title>Khaled | About Page</title>
        <meta name="description" content="This page describe about me" />
      </Head>
        ...
        <Layout className="pt-16">
          <div>
            ...
            <div className="grid w-full grid-cols-8 gap-16">
              ...
              <div className="col-span-3 relative h-max rounded-2xl bottom-2 border border-solid border-dark bg-light p-8">
